...
void displayHOME(int &start, int &end){
	char  NewDirPath[200];
	string newPath="/home/rishabh/";
	strcpy(NewDirPath, newPath.c_str());
	if(chdir(NewDirPath)<0){
		cout<<"error"<<endl;
		exit(0);
